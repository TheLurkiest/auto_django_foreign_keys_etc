...
#p_list_all_grass = ['Hoppip', 'Skiploom', 'Jumpluff', 'Sunkern', 'Sunflora', 'Celebi', 'back/Hoppip', 'back/Skiploom', 'back/Jumpluff', 'back/Sunkern', 'back/Sunflora', 'back/Celebi']
#p_list_all_grass = ['Leafeon']

p_list_all_grass = ['shiftry']
...
if(len(a1_poke_id) > 1):
    ...
    a1_poke_id = input('enter g or e if this pokemon is grass or electric-- otherwise just hit enter: ')
    

p_type_choice = a1_poke_id
if(a1_poke_id == 'g'):
    if(len(p_list_to_change) < 1):
